package com.planet_ink.marble_mud.Areas.interfaces;
...
public interface Area extends Economics, PhysicalAgent
{
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#FLAG_THIN
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#THEME_FANTASY
	...
	/**
	 * Returns the marblemud .cmare filename that will be used when the EXPORT command
	 * is used in such a way as to auto-generate filenames. 
	 * @return the name of the .cmare filename to use
	 */
	public String getArchivePath();
	/**
	 * Sets the marblemud .cmare filename that will be used when the EXPORT command
	 * is used in such a way as to auto-generate filenames. 
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Climate
	 * @return a com.planet_ink.marble_mud.Common.interfaces.Climate object
	 */
	 ...
	 * current and future weather for this area.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Climate
	 * @param obj a com.planet_ink.marble_mud.Common.interfaces.Climate object
	 */
	 ...
	 * areas.  
	 * @see com.planet_ink.marble_mud.Common.interfaces.TimeClock
	 * @return a com.planet_ink.marble_mud.Common.interfaces.TimeClock object
	 */
	 ...
	 * areas.  
	 * @see com.planet_ink.marble_mud.Common.interfaces.TimeClock
	 * @param obj a com.planet_ink.marble_mud.Common.interfaces.TimeClock object
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#CLIMASK_COLD
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#getBlurbFlag(String)
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#addMetroRoom(Room)
	 * @see com.planet_ink.marble_mud.Locales.interfaces.Room
	 ...
	 * from parent areas.
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#delMetroRoom(Room)
	 * @see com.planet_ink.marble_mud.Locales.interfaces.Room
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#getCompleteMap()
	 * @see com.planet_ink.marble_mud.Locales.interfaces.Room
	 ...
	 * add-ons.
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#getProperMap()
	 * @see com.planet_ink.marble_mud.Locales.interfaces.Room
	 * @return an enumerator of Room objects
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.RoomnumberSet
	 * @return a com.planet_ink.marble_mud.Common.interfaces.RoomnumberSet object
	 */
	 ...
	 * those not yet loaded.
	 * @see com.planet_ink.marble_mud.Common.interfaces.RoomnumberSet
	 * @param set a com.planet_ink.marble_mud.Common.interfaces.RoomnumberSet object
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#STATE_ACTIVE
	 * @param newState
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#delSubOp(String)
	 * @param username a players Name
	 */
	public void addSubOp(String username);
	/**
	 * Removes a SubOp to this area.  
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#addSubOp(String)
	 * @param username a players Name
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#getAreaIStats()
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#AREASTAT_AVGALIGN
	...
	/**	Bitmap flag meaning that the object supports magic.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#getTechLevel() */
	public final static int THEME_FANTASY=1;
	/**	Bitmap flag meaning that the object supports technology.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#getTechLevel() */
	public final static int THEME_TECHNOLOGY=2;
	/**	Bitmap flag meaning that the object supports super powers.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#getTechLevel() */
	public final static int THEME_HEROIC=4;
	/**	Bitmap flag meaning that the object only supports usage of above in Skills.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#getTechLevel() */
	...
	/**	Bitmap climate flag meaning that the area has normal weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMASK_NORMAL=0;
	/**	Bitmap climate flag meaning that the area has wet weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMASK_WET=1;
	/**	Bitmap climate flag meaning that the area has cold weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMASK_COLD=2;
	/**	Bitmap climate flag meaning that the area has windy weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMATE_WINDY=4;
	/**	Bitmap climate flag meaning that the area has hot weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMASK_HOT=8;
	/**	Bitmap climate flag meaning that the area has dry weather.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int CLIMASK_DRY=16;
	/**	Indexed description of the CLIMASK_ bitmap constants in all possible combinations.  
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#CLIMASK_NORMAL 
	 */
	public final static String[] CLIMATE_DESCS={"NORMAL","WET","COLD","WINDY","HOT","DRY"};
	/**	Number of CLIMASK_ constants.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int NUM_CLIMATES=6;
	/**	Bitmap climate flag meaning that the area has all weather modifiers.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#climateType() */
	public final static int ALL_CLIMATE_MASK=31;
	
	/**	State flag meaning this area is a THIN type area.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_THIN=1;
	/**	State flag meaning this area is a INSTANCE parent type area.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_INSTANCE_PARENT=2;
	/**	State flag meaning this area is a INSTANCE child type area.  @see com.planet_ink.marble_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_INSTANCE_CHILD=4;
	
	/** Various area IStat constants.. see @see com.planet_ink.marble_mud.Areas.interfaces.Area#getAreaIStats() */
	 ...
	 * @see com.planet_ink.marble_mud.Areas.interfaces.Area#getAreaFlags() 
	 * 
	 */

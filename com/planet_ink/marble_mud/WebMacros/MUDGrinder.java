...
import com.planet_ink.marble_mud.WebMacros.grinder.*;
...
public class MUDGrinder extends StdWebMacro
{
	...
	public String runMacro(ExternalHTTPRequests httpReq, String parm)
	{
		...
		if(parms.containsKey("DELRACE"))
		{
			...
			CMClass.loadClass(CMObjectType.RACE,"com/planet_ink/marble_mud/Races/"+oldRID+".class",true);
		...
		if(parms.containsKey("DELCLASS"))
		{
			...
			CMClass.loadClass(CMObjectType.CHARCLASS,"com/planet_ink/marble_mud/CharClasses/"+oldCID+".class",true);

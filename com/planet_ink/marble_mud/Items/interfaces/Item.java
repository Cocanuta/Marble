...
public interface Item extends Rider, DBIdentifiable, Wearable, PhysicalAgent, Readable
{
	...
	/** 
	 * The default value of the item, represented in the base marblemud currency.  This
	...
	public int value();
	/**
	 * The user/builder-entered value of the item, represented in base marblemud currency.
	 * It is used as a basis for the value returned by the value() method.
	 * @return the raw user-entered value of item.
	 */    
	public int baseGoldValue();
	/**
	 * Changes the base value of the item, represented in base marblemud currency.
	 ...
	 * @see com.planet_ink.marble_mud.core.interfaces.ItemPossessor#addItem(Item)

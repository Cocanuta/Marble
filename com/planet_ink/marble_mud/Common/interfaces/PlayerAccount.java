...
import com.planet_ink.marble_mud.Libraries.interfaces.PlayerLibrary;
import com.planet_ink.marble_mud.MOBS.interfaces.MOB;
import com.planet_ink.marble_mud.core.interfaces.Modifiable;
...
public interface PlayerAccount extends CMCommon, AccountStats, Modifiable
{
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.PlayerAccount#setFlag(String, boolean)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.PlayerAccount#isSet(String)
	 * @param flagName the flag name

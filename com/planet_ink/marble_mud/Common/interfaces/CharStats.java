...
public interface CharStats extends CMCommon, Modifiable
{
   ...
   /**
	 ...
	 * @see com.planet_ink.marble_mud.CharClasses.interfaces.CharClass
	 ...
	 * @see com.planet_ink.marble_mud.CharClasses.interfaces.CharClass#getLevelCap()
	 ...
	 * @see com.planet_ink.marble_mud.Races.interfaces.Race#startRacing(MOB, boolean)
	 * @see com.planet_ink.marble_mud.Races.interfaces.Race
	 ...
	 * @see com.planet_ink.marble_mud.CharClasses.interfaces.CharClass
	 * @see com.planet_ink.marble_mud.Common.interfaces.CharStats#displayClassName()
	 * @see #setDisplayClassName(String)
	 * @see #displayClassLevel(MOB, boolean)
	 * @param mob the mob whose class and overall level to display
	 * @return the name of this mobs current class.
	 ...
	 * @see com.planet_ink.marble_mud.Races.interfaces.Race#AGE_DESCS
	...
	public class CODES
	{
		...
		public CODES(){
			...
			for(int i=0;i<addExtra.length+repExtra.length;i++)
			{
				...
				if(V.size()!=4)
				{
					Log.errOut("CharStats","Bad marblemud.ini charstat row, requires 4 ; separated entries: "+p);
					continue;
				}
				...
				if(replace)
				{
					...
					{
						Log.errOut("CharStats","Bad marblemud.ini charstat row, bad stat name: "+repStat);
						continue;
					}
				}
				...
				if(replace&&(oldStatCode>=0))
				{
					...
					Log.errOut("CharStats","Bad marblemud.ini charstat row, bad type: "+type);
			}
		}

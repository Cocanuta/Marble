...
import com.planet_ink.marble_mud.Libraries.interfaces.CharCreationLibrary;
...
public interface Session extends CMCommon, Modifiable, CMRunnable
{
	 ...
	 * indexed by marblemud color code.  May be from the standard list, 
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#out(char[])
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#onlyPrint(String, boolean)
	 * @param msg the string to send to the user
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#rawPrintln(String)
	 * @param msg the string to send to the user
	 */
	 ...
	 * additional pre-linefeed if currently at
	 * the prompt.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#rawPrint(String)
	 * @param msg the string to send to the user
	 */
	 ...
	 * on disconnnect.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String, long)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String, String, long)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String, String)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#prompt(String, long)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 ...
	 * disconnect.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#confirm(String, String, long)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 ...
	 * on disconnnect or time out.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#confirm(String, String)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 * @param maxTime max number of milliseconds to wait before timing out
	 * @return true if they entered Y, false otherwise
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#choose(String, String, String, long)
	 * @param Message the prompt message to display to the user
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#choose(String, String, String)
	 * @param Message the prompt message to display to the user
	 * @param Choices a list of uppercase characters that may be entered
	 * @param Default the default response if the user just hits enter
	 * @param maxTime max number of milliseconds to wait before timing out
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#startBeingSnoopedBy(Session)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#stopBeingSnoopedBy(Session)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#amBeingSnoopedBy(Session)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#snoopSuspension(int)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#isStopped()
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#logout(boolean)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#isStopped()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setAfkFlag(boolean)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setAFKMessage(String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#afkFlag()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#afkMessage()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setMob(MOB)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#mob()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#convertEscape(StringBuffer, int)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#lastColor(ColorState)
	 ...
	 * @param newColor the color to change it to
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#currentColor(ColorState)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#convertEscape(StringBuffer, int)
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#STATUS_LOGIN
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setLastPKFight()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setLastNPCFight()
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#getLastPKFight()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#getLastNPCFight()
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#updateLoopTime()
	 * 
	 ...
	 * Is typically only held up by executing a user command, so it is an accurate
	 * gauge of a locked up user command.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#lastLoopTime()
	 */
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#serverTelnetMode(int)
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setServerTelnetMode(int, boolean)
	 * @param telnetCode the telnet code
	 * 
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#clientTelnetMode(int)
	 * 
	 * @param telnetCode the telnet code
	 * @param onOff true to turn on, false to turn off the flag
	 */
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#setClientTelnetMode(int, boolean)
	 * 
	 * @param telnetCode the telnet code
	 * 
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB#getBitmap()
	 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB#ATT_MXP
	 * @see com.planet_ink.marble_mud.Common.interfaces.Session#changeTelnetMode(int, boolean)

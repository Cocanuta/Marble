 ...
 * 
 * @see com.planet_ink.marble_mud.core.interfaces.Environmental#Name()
 * @see com.planet_ink.marble_mud.core.interfaces.Environmental#setName(String)
 * 
 * Managed by the SocialsList library.
 * 
 * @see com.planet_ink.marble_mud.Common.interfaces.Social
 * @see com.planet_ink.marble_mud.Libraries.interfaces.SocialsList
 */
...
public interface Social extends Environmental, CMCommon
{
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setYou_see(String)
	 ...
	 * You_see: what the player themself sees when they use this social.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#You_see()
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setThird_party_sees(String)
	 ...
	 * sees when a player uses this social.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#Third_party_sees()
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setTarget_sees(String)
	 ...
	 * Target_sees: what the target of this social sees when social is used on them.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#Target_sees()
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setSee_when_no_target(String)
	 ...
	 * the target is not available.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#See_when_no_target()
	 * @param str the string seen by the player when the target has left
	 */
	public void setSee_when_no_target(String str);
	
	/**
	 * The official marblemud message code used as the source code for this social,
	 * which reflects what the player is doing.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setSourceCode(int)
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	 * @return the CMMsg social code, fully formed
	 */
	public int sourceCode();
	
	/**
	 * Sets the official marblemud message code used as the source code for this social,
	 * which reflects what the player is doing.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#sourceCode()
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	...
	/**
	 * The official marblemud message code used as the others code for this social,
	 * which reflects what the player appears to be doing.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setOthersCode(int)
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_OK_VISUAL
	 * @return the CMMsg social code, fully formed
	 */
	public int othersCode();
	
	/**
	 * Sets the official marblemud message code used as the others code for this social,
	 * which reflects what the player appears to be doing.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#othersCode()
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	...
	/**
	 * The official marblemud message code used as the target code for this social,
	 * which reflects what is being done to the target.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setTargetCode(int)
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	...
	/**
	 * Sets the official marblemud message code used as the target code for this social,
	 * which reflects what is being done to the target.  Only certain codes allowed.
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#targetCode()
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_SPEAK
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_HANDS
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISE
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg#MSG_NOISYMOVEMENT
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#setMSPfile(String)
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#MSPfile()
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#makeMessage(MOB, String, String, int, int, Vector, String, boolean)
	 * 
	 ...
	 * 
	 * @see com.planet_ink.marble_mud.Common.interfaces.CMMsg
	 * @see com.planet_ink.marble_mud.Common.interfaces.Social#makeChannelMsg(MOB, int, String, Vector, boolean)
	 * 
	 * @param mob the mob doing the social

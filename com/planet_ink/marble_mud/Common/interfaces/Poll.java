 ...
 * and private voting polls available through the marblemud POLL 
 * CREATE POLL, LIST POLLS, etc.. commands.
 * 
 * These objects are managed by the PollManager Library
 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager
 * @see com.planet_ink.marble_mud.core.CMLib#polls()
 */
public interface Poll extends CMCommon
{
	/**
	 * A name for this poll, used for internal purposes only.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setName(String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getName()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setSubject(String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getSubject()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setDescription(String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getDescription()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setAuthor(String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getAuthor()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setFlags(long)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_ABSTAIN
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_ACTIVE
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getFlags()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_ABSTAIN
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_ACTIVE
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setQualZapper(String)
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.MaskingLibrary#maskCheck(String, Environmental, boolean)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getQualZapper()
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.MaskingLibrary#maskCheck(String, Environmental, boolean)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setExpiration(long)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getExpiration()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setOptions(List)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollOption
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getOptions()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollOption
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getResults()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollResult
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getOptions()
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollOption
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#setLoaded(boolean)
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 ...
	 * loaded and populated into this object from the database.
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#loaded()
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 ...
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#addVoteResult(com.planet_ink.marble_mud.Common.interfaces.Poll.PollResult)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollResult
	 ...
	 * @see com.planet_ink.marble_mud.Libraries.interfaces.PollManager#loadPollIfNecessary(Poll)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getMyVote(MOB)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll.PollResult
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#getMyVote(MOB)
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_VOTEBYIP
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_ACTIVE
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_HIDERESULTS
	 * @see com.planet_ink.marble_mud.Common.interfaces.Poll#FLAG_PREVIEWRESULTS
	 * @param mob the mob to check for elligibility

 ...
 * The marblemud engine keeps counters on all manner of different game events,
 * such as logins, new players, levels, deaths, and others.  CoffeeTableRows
 * are managed by the CoffeeTables library.
 * @see com.planet_ink.marble_mud.Libraries.interfaces.StatisticsLibrary
 */
public interface CoffeeTableRow extends CMCommon
{
	/**
	 * The start time, in millis since 1970, for this row of data
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#setStartTime(long)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#setEndTime(long)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#startTime()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#endTime()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#numberOnlineCounter()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#numberOnlineTotal()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#populate(long, long, String)
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#data()
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#STAT_LOGINS
	 ...
	 * together
	 * @see com.planet_ink.marble_mud.Common.interfaces.CoffeeTableRow#STAT_TOTAL

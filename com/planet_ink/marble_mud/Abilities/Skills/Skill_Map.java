...
public class Skill_Map extends StdSkill
{
	...
	public void executeMsg(final Environmental myHost, final CMMsg msg)
	{
		...
		&&(!CMath.bset(((Room)msg.target()).phyStats().sensesMask(),PhyStats.SENSE_ROOMUNMAPPABLE)))
		{
			...
			if(map instanceof com.planet_ink.marble_mud.Items.interfaces.RoomMap)
				((com.planet_ink.marble_mud.Items.interfaces.RoomMap)map).doMapArea();
		}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(item instanceof com.planet_ink.marble_mud.Items.interfaces.RoomMap)
		{

 ...
 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB#addAbility(Ability)
 * @see com.planet_ink.marble_mud.core.interfaces.Affectable#addEffect(Ability)
 */
...
public interface Ability extends Environmental
{
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()
	 * @see Ability
	 * @return Ability.QUALITY_* constant classification
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#setInvoker(MOB)
	 ...
	 * skill or effect.
	 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#invoker()
	 ...
	 * like sleep.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#setAffectedOne(Physical)
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#affecting()
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#triggerStrings()
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#putInCommandlist()
	 ...
	 * is not in combat.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#combatCastingTime(MOB, List)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#checkedCastingCost(MOB, List)
	 * @param mob the potential caster
	 ...
	 * instantly.  This method only applies when the invoker
	 * is in combat.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#castingTime(MOB, List)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#checkedCastingCost(MOB, List)
	 * @param mob the potential caster
	 * @param commands the potential command set
	 * @return the number of player free actions required to do this
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#invoke(MOB, Vector, Physical, boolean, int)
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canBeUninvoked()
	 */
	 ...
	 * behave normally.
	 * @see com.planet_ink.marble_mud.Items.interfaces.Item#owner()
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#makeNonUninvokable()
	 ...
	 * @see com.planet_ink.marble_mud.core.interfaces.Affectable#addNonUninvokableEffect(Ability)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canBeUninvoked()
	 */
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#isAutoInvoked()
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#isNowAnAutoEffect()
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType()
	 * @see Ability
	 ...
	 * of the teacher.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canBeLearnedBy(MOB, MOB)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#teach(MOB, MOB)
	 ...
	 * to both.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#practice(MOB, MOB)
	 ...
	 * to both.  This method should focus exclusively on the qualifications
	 * of the student.
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canBeTaughtBy(MOB, MOB)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#teach(MOB, MOB)
	 * @param teacher the potential teacher of this skill
	 * @param student the potential learner of this skill
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canBePracticedBy(MOB, MOB)
	 * @param teacher the teacher of this skill
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.StdAbility#canTargetCode()
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.StdAbility#canAffectCode()
	 ...
	 * checks of Prayers.  
	 * @see com.planet_ink.marble_mud.Abilities.Prayers.Prayer
	 * @see com.planet_ink.marble_mud.Common.interfaces.Faction
	 ...
	 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB#addAbility(Ability)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#setProficiency(int)
	 ...
	 * Abilities, such as Drowning.
	 * @see com.planet_ink.marble_mud.MOBS.interfaces.MOB#addAbility(Ability)
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#proficiency()
	...
	/** usageType() constant meaning that the skill is free @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType()*/
	public final static int USAGE_NADA=0;
	/** usageType() constant meaning that the skill costs mana @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType()*/
	public final static int USAGE_MANA=1;
	/** usageType() constant meaning that the skill costs movement @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType()*/
	public final static int USAGE_MOVEMENT=2;
	/** usageType() constant meaning that the skill costs hp @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType()*/
	public final static int USAGE_HITPOINTS=4;
	/** constant descriptions for the USAGE_* values @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageType() */
	public final static String[] USAGE_DESCS={"MANA","MOVEMENT","HITPOINTS"};
	
	/** index into internal cache used by usageCost(MOB,boolean) @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	...
	/** Constant for overrideMana to denote that the skill uses all of a players mana @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	public final static int COST_ALL=Integer.MAX_VALUE;
	/** Constant for overrideMana to denote that the skill uses a % of a players mana @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	public final static int COST_PCT=Integer.MAX_VALUE-100;
	
	/** index into usageCost(MOB,boolean) array for the amount of mana this skill costs @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	public final static int USAGEINDEX_MANA=0;
	/** index into usageCost(MOB,boolean) array for the amount of moves this skill costs @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	public final static int USAGEINDEX_MOVEMENT=1;
	/** index into usageCost(MOB,boolean) array for the amount of hp this skill costs @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#usageCost(MOB,boolean) */
	public final static int USAGEINDEX_HITPOINTS=2;

	/** constant returned by classificationCode() designating this ability as a Skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_SKILL=0;
	/** constant returned by classificationCode() designating this ability as a Spell @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_SPELL=1;
	/** constant returned by classificationCode() designating this ability as a Prayer @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_PRAYER=2;
	/** constant returned by classificationCode() designating this ability as a Song @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_SONG=3;
	/** constant returned by classificationCode() designating this ability as a Trap @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_TRAP=4;
	/** constant returned by classificationCode() designating this ability as a Property @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_PROPERTY=5;
	/** constant returned by classificationCode() designating this ability as a Thief Skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_THIEF_SKILL=6;
	/** constant returned by classificationCode() designating this ability as a Language @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_LANGUAGE=7;
	/** constant returned by classificationCode() designating this ability as a Chant @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_CHANT=8;
	/** constant returned by classificationCode() designating this ability as a Common Skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_COMMON_SKILL=9;
	/** constant returned by classificationCode() designating this ability as a Disease @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_DISEASE=10;
	/** constant returned by classificationCode() designating this ability as a Poison @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_POISON=11;
	/** constant returned by classificationCode() designating this ability as a Super Power @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int ACODE_SUPERPOWER=12;
	/** constant returned by classificationCode() designating this ability as a Archon ONly Skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	...
	/** constant mask returned by classificationCode() designating this ability as being Divination @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DIVINATION=1<<5;
	/** constant mask returned by classificationCode() designating this ability as being Abjuration @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ABJURATION=2<<5;
	/** constant mask returned by classificationCode() designating this ability as being Illusion @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ILLUSION=3<<5;
	/** constant mask returned by classificationCode() designating this ability as being Evocation @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_EVOCATION=4<<5;
	/** constant mask returned by classificationCode() designating this ability as being Alteration @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ALTERATION=5<<5;
	/** constant mask returned by classificationCode() designating this ability as being Transmutation @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_TRANSMUTATION=6<<5;
	/** constant mask returned by classificationCode() designating this ability as being Enchantment @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ENCHANTMENT=7<<5;
	/** constant mask returned by classificationCode() designating this ability as being Conjuration @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CONJURATION=8<<5;
	/** constant mask returned by classificationCode() designating this ability as being Archon @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ARCHON=9<<5;
	/** constant mask returned by classificationCode() designating this ability as being Singing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_SINGING=10<<5;
	/** constant mask returned by classificationCode() designating this ability as being Dancing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DANCING=11<<5;
	/** constant mask returned by classificationCode() designating this ability as being Playing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_PLAYING=12<<5;
	/** constant mask returned by classificationCode() designating this ability as being Deceptive @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DECEPTIVE=13<<5;
	/** constant mask returned by classificationCode() designating this ability as being Detrapping @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DETRAP=14<<5;
	/** constant mask returned by classificationCode() designating this ability as being RopeUsing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_BINDING=15<<5;
	/** constant mask returned by classificationCode() designating this ability as being Stealing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_STEALING=16<<5;
	/** constant mask returned by classificationCode() designating this ability as being Stealthy @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_STEALTHY=17<<5;
	/** constant mask returned by classificationCode() designating this ability as being Trapping @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_TRAPPING=18<<5;
	/** constant mask returned by classificationCode() designating this ability as being Alert @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ALERT=19<<5;
	/** constant mask returned by classificationCode() designating this ability as being holy protection @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_HOLYPROTECTION=20<<5;
	/** constant mask returned by classificationCode() designating this ability as being healing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_HEALING=21<<5;
	/** constant mask returned by classificationCode() designating this ability as being vexing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_VEXING=22<<5;
	/** constant mask returned by classificationCode() designating this ability as being blessing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_BLESSING=23<<5;
	/** constant mask returned by classificationCode() designating this ability as being cursing @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CURSING=24<<5;
	/** constant mask returned by classificationCode() designating this ability as being evangelistic @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_EVANGELISM=25<<5;
	/** constant mask returned by classificationCode() designating this ability as being moon summoning @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_MOONSUMMONING=26<<5;
	/** constant mask returned by classificationCode() designating this ability as being moon altering @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_MOONALTERING=27<<5;
	/** constant mask returned by classificationCode() designating this ability as being gathering skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_GATHERINGSKILL=28<<5;
	/** constant mask returned by classificationCode() designating this ability as being crafting skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CRAFTINGSKILL=29<<5;
	/** constant used to mask classificationCode() designating this ability as being plant growth skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_PLANTGROWTH=30<<5;
	/** constant used to mask classificationCode() designating this ability as being shape shifting skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_SHAPE_SHIFTING=31<<5;
	/** constant used to mask classificationCode() designating this ability as being foolish skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_FOOLISHNESS=32<<5;
	/** constant used to mask classificationCode() designating this ability as being room ward skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_WARDING=33<<5;
	/** constant used to mask classificationCode() designating this ability as being death lore skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DEATHLORE=34<<5;
	/** constant used to mask classificationCode() designating this ability as being weather skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_WEATHER_MASTERY=35<<5;
	/** constant used to mask classificationCode() designating this ability as being corrupting skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CORRUPTION=36<<5;
	/** constant used to mask classificationCode() designating this ability as being restoring skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_RESTORATION=37<<5;
	/** constant used to mask classificationCode() designating this ability as being neutralizing skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_NEUTRALIZATION=38<<5;
	/** constant used to mask classificationCode() designating this ability as being neutralizing skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CREATION=39<<5;
	/** constant used to mask classificationCode() designating this ability as being communing skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_COMMUNING=40<<5;
	/** constant used to mask classificationCode() designating this ability as being preserving skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_PRESERVING=41<<5;
	/** constant used to mask classificationCode() designating this ability as being enduring skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ENDURING=42<<5;
	/** constant used to mask classificationCode() designating this ability as being plant control skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_PLANTCONTROL=43<<5;
	/** constant used to mask classificationCode() designating this ability as being animal affinity skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ANIMALAFFINITY=44<<5;
	/** constant used to mask classificationCode() designating this ability as being deep magic skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DEEPMAGIC=45<<5;
	/** constant used to mask classificationCode() designating this ability as being breeding skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_BREEDING=46<<5;
	/** constant used to mask classificationCode() designating this ability as being weapon use skil. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_WEAPON_USE=47<<5;
	/** constant used to mask classificationCode() designating this ability as being breeding skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ROCKCONTROL=48<<5;
	/** constant used to mask classificationCode() designating this ability as being kicking skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_KICKING=49<<5;
	/** constant used to mask classificationCode() designating this ability as being punching skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_PUNCHING=50<<5;
	/** constant used to mask classificationCode() designating this ability as being grappling skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_GRAPPLING=51<<5;
	/** constant used to mask classificationCode() designating this ability as being calligraphy skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_CALLIGRAPHY=52<<5;
	/** constant used to mask classificationCode() designating this ability as being poisoning skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_POISONING=53<<5;
	/** constant used to mask classificationCode() designating this ability as being arcane lore skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ARCANELORE=54<<5;
	/** constant used to mask classificationCode() designating this ability as being acrobatic skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_ACROBATIC=55<<5;
	/** constant used to mask classificationCode() designating this ability as being amorous skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_INFLUENTIAL=56<<5;
	/** constant used to mask classificationCode() designating this ability as being street smarts skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_STREETSMARTS=57<<5;
	/** constant used to mask classificationCode() designating this ability as being nature lore skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_NATURELORE=58<<5;
	/** constant used to mask classificationCode() designating this ability as being dirty fighting skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_DIRTYFIGHTING=59<<5;
	/** constant used to mask classificationCode() designating this ability as being combat lore skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_COMBATLORE=60<<5;
	/** constant used to mask classificationCode() designating this ability as being combat fluidity skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_COMBATFLUIDITY=61<<5;
	/** constant used to mask classificationCode() designating this ability as being evasive skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_EVASIVE=62<<5;
	/** constant used to mask classificationCode() designating this ability as being martial lore skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	public static final int DOMAIN_MARTIALLORE=63<<5;
	/** constant used to mask classificationCode() designating this ability as being racial ability skill. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	...
	/** constant used to mask classificationCode() to return only the higher order DOMAIN_* constant. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#classificationCode() */
	...
	/** constant descriptions for the minRange()/maxRange() values @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#minRange() */
	...
	/** constant mask for the flags() method designating that this ability is a binding effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_BINDING=1;
	/** constant mask for the flags() method designating that this ability is a room-moving skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_MOVING=2;
	/** constant mask for the flags() method designating that this ability is a transporting skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_TRANSPORTING=4;
	/** constant mask for the flags() method designating that this ability is a weather-affecting skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_WEATHERAFFECTING=8;
	/** constant mask for the flags() method designating that this ability is a summoning skill @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_SUMMONING=16;
	/** constant mask for the flags() method designating that this ability is a charming effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_CHARMING=32;
	/** constant mask for the flags() method designating that this ability is a tracking-causing effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_TRACKING=64;
	/** constant mask for the flags() method designating that this ability is a heating effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_HEATING=128;
	/** constant mask for the flags() method designating that this ability is a burning effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_FIREBASED=256;
	/** constant mask for the flags() method designating that this ability is a holy or neutral effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_HOLY=512;
	/** constant mask for the flags() method designating that this ability is a unholy or neutral effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_UNHOLY=1024;
	/** constant mask for the flags() method designating that this ability is a paralyzing effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_PARALYZING=2048;
	/** constant mask for the flags() method designating that this ability may not be ordered @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_NOORDERING=4096;
	/** constant mask for the flags() method designating that this ability is a clan magic @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_CLANMAGIC=8192;
	/** constant mask for the flags() method designating that this ability is healing magic @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_HEALINGMAGIC=16384;
	/** constant mask for the flags() method designating that this ability is a freezing effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_WATERBASED=32768;
	/** constant mask for the flags() method designating that this ability is a washing effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_AIRBASED=65536;
	/** constant mask for the flags() method designating that this ability is a grounded effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_EARTHBASED=131072;
	/** constant mask for the flags() method designating that this ability is an intoxicating effect @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_INTOXICATING=262144;
	/** constant mask for the flags() method designating that this ability adjusts char/phy/base stats @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_ADJUSTER=524288;
	/** constant mask for the flags() method designating that this ability resists/saves @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_RESISTER=1048576;
	/** constant mask for the flags() method designating that this ability blocks certain negative affects @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_IMMUNER=2097152;
	/** constant mask for the flags() method designating that this ability blocks getting and other mundane actions @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_ZAPPER=4194304;
	/** constant mask for the flags() method designating that this ability casts some other spell/ability @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_CASTER=8388608;
	/** constant mask for the flags() method designating that this ability grants another spell/ability @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	public static final long FLAG_ENABLER=16777216;
	/** constant mask for the flags() method designating that the thing with this ability cant be learned as a recipe @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#flags() */
	...
	/* constant for the abstractQuality and other methods.  Means that this skill would not make the target happy. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_MALICIOUS=0;
	/* constant for the abstractQuality and other methods.  Means that this skill would not make the target either happy or unhappy. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_INDIFFERENT=1;
	/* constant for the abstractQuality and other methods.  Means that this skill targets the invoker, and is harmless, but only useful in qualified situations. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_OK_SELF=2;
	/* constant for the abstractQuality and other methods.  Means that this skill targets the invoker or others, and is harmless, but only useful in qualified situations. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_OK_OTHERS=3;
	/* constant for the abstractQuality and other methods.  Means that this skill targets the invoker, and is always beneficial. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_BENEFICIAL_SELF=4;
	/* constant for the abstractQuality and other methods.  Means that this skill targets the invoker or others, and is always beneficial. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality()*/
	public static final int QUALITY_BENEFICIAL_OTHERS=5;
	/* descriptive list of the QUALITY_ flags. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#abstractQuality() */
	public static final String[] QUALITY_DESCS={"MALICIOUS","INDIFFERENT","OK_SELF","OK_OTHERS","BENEFICIAL_SELF","BENEFICIAL_OTHERS"};

	/* descriptive list of the CAN_ flags. @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */
	public static final String[] CAN_DESCS={"MOBS","ITEMS","AREAS","ROOMS","EXITS"};
	/** constant mask for the canTargetCode() and canAffectCode() methods.  Means it can target/affect mobs @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */
	public static final int CAN_MOBS=1;
	/** constant mask for the canTargetCode() and canAffectCode() methods.  Means it can target/affect items @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */
	public static final int CAN_ITEMS=2;
	/** constant mask for the canTargetCode() and canAffectCode() methods.  Means it can target/affect areas @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */
	public static final int CAN_AREAS=4;
	/** constant mask for the canTargetCode() and canAffectCode() methods.  Means it can target/affect rooms @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */
	public static final int CAN_ROOMS=8;
	/** constant mask for the canTargetCode() and canAffectCode() methods.  Means it can target/affect exits @see com.planet_ink.marble_mud.Abilities.interfaces.Ability#canAffectCode() */

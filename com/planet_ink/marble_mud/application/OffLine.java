...
import com.planet_ink.marble_mud.core.CMFile.CMVFSDir;
...
import com.planet_ink.marble_mud.Libraries.interfaces.JournalsLibrary.JournalSummaryStats;
...
import com.planet_ink.marble_mud.Libraries.interfaces.PlayerLibrary.ThinnerPlayer;
	...
	throws SocketException, IOException
{
	...
	public static void main(String a[])
	{
		...
		if(nameID.length()==0) nameID="Unnamed marblemud";
		try
		{
			while(true)
			{
				...
				System.out.println();
				System.out.println("marblemud Off-Line");
				System.out.println("(C) 2000-2012 Bo Zimmerman");
				System.out.println("http://www.marblemud.org");

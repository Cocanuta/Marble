package com.planet_ink.marble_mud.Exits.interfaces;
import com.planet_ink.marble_mud.core.interfaces.*;
import com.planet_ink.marble_mud.core.interfaces.Readable;
...
public interface Exit extends PhysicalAgent, Readable
{
	 ...
	 * being used.
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasADoor()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasALock()
	 ...
	 * being used.
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#isOpen()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#isLocked()
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasADoor()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#defaultsClosed()
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasADoor()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#defaultsLocked()
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setKeyName(String)
	 * @return the key code
	 */
	 ...
	 * representing the key code required to unlock/lock the door.
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#keyName()
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setExitParams(String, String, String, String)
	 ...
	 * lower, drop, etc..
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#openWord()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasADoor()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#defaultsClosed()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setExitParams(String, String, String, String)
	 ...
	 * raise, lift, etc..
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#closeWord()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#hasADoor()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#defaultsClosed()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setExitParams(String, String, String, String)
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#closeWord()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#openWord()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#doorName()
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#closedText()
	 ...
	 * defaults in a closed state.
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setOpenDelayTicks(int)
	 * @see com.planet_ink.marble_mud.core.interfaces.Tickable#TICKID_EXIT_REOPEN
	 ...
	 * or player changes it from a closed to an open state, and the door
	 * defaults in a closed state.
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#openDelayTicks()
	 * @see com.planet_ink.marble_mud.core.interfaces.Tickable#TICKID_EXIT_REOPEN
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#setTemporaryDoorLink(String)
	 ...
	 * @see com.planet_ink.marble_mud.Exits.interfaces.Exit#temporaryDoorLink()

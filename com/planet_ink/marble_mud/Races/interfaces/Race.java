package com.planet_ink.marble_mud.Races.interfaces;
...
public interface Race extends Tickable, StatsAffecting, MsgListener, CMObject, Modifiable
{
	 ...
	 * @see com.planet_ink.marble_mud.Common.interfaces.CharState#getHitPoints()
	 ...
	 * @see com.planet_ink.marble_mud.Items.interfaces.Weapon
	 ...
	 * @see com.planet_ink.marble_mud.Items.interfaces.RawMaterial
	 ...
	 * @see com.planet_ink.marble_mud.Abilities.interfaces.Ability
	 * @see com.planet_ink.marble_mud.Races.interfaces.Race#numRacialEffects(MOB)
	 * @param mob the mob to grant the abilities to
	 * @return a vector of the Ability objects
	 */

package com.planet_ink.marble_mud.core.intermud.i3.server;
...
/**
 * com.planet_ink.marble_mud.core.intermud.i3.server.ServerThread
 ...
 * @version 1.0
 * @see com.planet_ink.marble_mud.core.intermud.i3.server.I3Server
 */
	...
	public void run() 
	{
		...
		try {
			Intermud.setup(intermuds,
						   (PersistentPeer)Class.forName("com.planet_ink.marble_mud.core.intermud.i3.IMudPeer").newInstance());
		}
		catch( Exception e ) {
			Log.errOut("I3Server",e);
			return;
		...
		while( running ) {
			...
			{// Get new connections
				...
				for(i=0; i<5; i++) {
					...
					try {
						new_user = (ServerUser)copyObject("com.planet_ink.marble_mud.core.intermud.i3.IMudUser");
					}

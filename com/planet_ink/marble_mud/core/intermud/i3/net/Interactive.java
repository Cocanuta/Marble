/**
 * com.planet_ink.marble_mud.core.intermud.i3.net.Interactive
...
import com.planet_ink.marble_mud.core.intermud.i3.server.ServerUser;
...
public abstract class Interactive implements ServerUser {
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerObject#getDestructed
	 */
	 ...
	 * should be called.
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerObject#processEvent
	 */
	 ...
	 * @see #input
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerUser#processInput
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerThread#run
	 */
	 ...
	 * editor.
	 * @param ob the instance of com.planet_ink.marble_mud.core.intermud.i3.net.Input to which input will be redirected
	 * @see com.planet_ink.marble_mud.core.intermud.i3.net.Input
	 * @see #input
	 */
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.net.InteractiveBody
	 */
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerObject#getObjectId
	 */
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerObject#setObjectId
	 */
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.server.ServerUser#setSocket
	 */
 ...
 * @author George Reese (borg@imaginary.com)
 * @version 1.0
 * @see com.planet_ink.marble_mud.core.intermud.i3.net.Interactive
 */
@SuppressWarnings({"unchecked","rawtypes"})
class InputThread implements Runnable {
	 ...
	 * @see com.planet_ink.marble_mud.core.intermud.i3.net.Interactive#loseLink
	 */
	public void run() {
		while( !destructed ) {
			String msg;

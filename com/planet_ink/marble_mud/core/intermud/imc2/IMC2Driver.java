...
import com.planet_ink.marble_mud.Commands.interfaces.Command;
...
public final class IMC2Driver extends Thread {
	...
	final static String IMC_VERSIONID  = "IMC2 4.00 for marblemud";
									  ...
									  String[][] channelMap)
	{
	   ...
	   imc_sequencenumber = imc_now;
		...
		imc_siteinfo.base="marblemud v"+CMProps.getVar(CMProps.SYSTEM_MUDVER);
